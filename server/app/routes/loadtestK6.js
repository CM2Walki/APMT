...
const routeContext = "loadtestK6";

//===============ROUTES=================
//displays our homepage
router.get("/", function(req, res){
  res.render("loadtestK6/home", {layout: "../loadtestK6/layouts/main", user: req.user} );
});

router.get("/describeAwsAutoscaleGroupsCompact", function(req, res) {
  // Retrieve user info
  awsGeneral.getUserInfoForDescription(req.user.username, res, req)
    .then(function (data) {
      if (data) {
        ...
        // Get compact auto scaling groups table
        awsGeneral.describeAutoscalingGroupsCompact(awsData, req, res, routeContext)
          .then(function (data) {
            if (data) {
              res.send(data);
            }
